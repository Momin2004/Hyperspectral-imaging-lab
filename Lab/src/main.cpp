...
// Define the pins and objects for encoder
// #define ENCODER_A 18
// #define ENCODER_B 19
...
const int eindschakelaar1 = 16; // Gebruik digitale pin 16
...
void loop() {
    ...
    // if (((!(currentState == Waiting) && !(currentState == Homing) && !(currentState == Accelerating) && digitalRead(eindschakelaar1) == HIGH)) || digitalRead(eindschakelaar2) == HIGH) {
    //     currentState = SafeStop;
    // }
